    ...
    <>
      ...
      {canManageBranding() ? (
        <div style={sectionStyle}>
          <div style={sectionHeaderStyle}>
            ...
            />
            <span style={sectionTitleStyle}>Tela de Login / Branding</span>
          </div>
          <div
            style={{
              marginBottom: 18,
          ...
          >
            <div style={{ fontSize: 14, fontWeight: 700, color: "#1f2937", marginBottom: 4 }}>
              Personalize a experiência da sua marca
            </div>
            <div style={{ fontSize: 12, color: "#6b7280", lineHeight: 1.6 }}>
              Configure banner, logo, links e textos da tela de login sem alterar código e sem
              novo build.
            </div>
          </div>
              ...
              <Grid spacing={2} container>
                ...
                <Grid xs={12} md={6} item>
                  <TextField
                    ...
                    helperText="Se deixar vazio, será usado o e-mail informado acima"
                    InputLabelProps={{ shrink: true }}
                  />
                </Grid>
                ...
                <Grid xs={12} md={6} item>
                  ...
                  >
                    ...
                    >
                      {loadingTestMail ? "ENVIANDO TESTE..." : "ENVIAR TESTE"}
                    </Button>
                    ...
                    >
                      {loadingMailSettings ? "SALVANDO..." : "SALVAR"}
                    </Button>
                  </div>
                </Grid>
              </Grid>
          ...
          <Grid spacing={2} container>
            <Grid xs={12} sm={6} md={4} item>
              <ToggleSetting
                label="Exibir botão do WhatsApp na tela de login"
            ...
            <Grid xs={12} sm={6} md={4} item>
              ...
              >
                ...
                <Select
                  ...
                  disableUnderline
                >
                  <MenuItem value={"url"}>URL da imagem</MenuItem>
                  <MenuItem value={"upload"}>Upload / imagem interna</MenuItem>
                </Select>
                    ...
                    <Grid xs={12} md={7} item>
                      <FormControl className={classes.selectContainer}>
                        <TextField
                          ...
                          name="loginLogoUrl"
                          margin="dense"
                          label="URL da Logo da Tela de Login"
                          variant="outlined"
                          value={loginLogoUrl}
                      ...
                      >
                        ...
                        >
                          <label htmlFor="loginLogoUploadInput">
                            ...
                            >
                              {loadingLoginLogoFile ? "Enviando..." : "Enviar Logo"}
                            </Button>
                          </label>
                          {!!loginLogoFileName && (
                            <Button
                        ...
                        >
                          Quando houver upload, ele terá prioridade sobre a URL da logo.
                        </div>
                      </div>
                    </Grid>
                      ...
                      >
                        ...
                        >
                          <label htmlFor="loginBannerUploadInput">
                            ...
                            >
                              {loadingLoginBannerImageFile ? "Enviando..." : "Enviar Banner"}
                            </Button>
                          </label>
                        ...
                        <div
                          style={{ fontSize: 11, color: "#64748b", marginTop: 10, lineHeight: 1.5 }}
                        >
                          Quando o modo estiver em "Upload / imagem interna", o sistema usará este
                          arquivo.
                        </div>
                      </div>
                    </Grid>
      ...
      {canManageMeta() ? (
        <div style={sectionStyle}>
          <div style={sectionHeaderStyle}>
            ...
            />
            <span style={sectionTitleStyle}>Integração Meta / Facebook / Instagram</span>
          </div>
          <div
            style={{
              marginBottom: 18,
          ...
          >
            <div style={{ fontSize: 14, fontWeight: 700, color: "#1f2937", marginBottom: 4 }}>
              Configure a conexão da Meta direto no sistema
            </div>
            <div style={{ fontSize: 12, color: "#6b7280", lineHeight: 1.6 }}>
              Esses dados serão usados na tela de conexões para login com Facebook e Instagram,
              sem depender de <strong>.env</strong> e sem precisar gerar novo build.
            </div>
          </div>
          <Grid spacing={2} container>
            <Grid xs={12} md={6} item>
              <FormControl className={classes.selectContainer}>
                ...
                <FormHelperText>
                  {loadingMetaAppId
                    ? "Atualizando..."
                    : "Informe o App ID do seu aplicativo na Meta"}
                </FormHelperText>
              </FormControl>
            </Grid>
              ...
              <FormControl className={classes.selectContainer}>
                ...
                <FormHelperText>
                  {loadingMetaAppSecret
                    ? "Atualizando..."
                    : "Informe o App Secret do seu aplicativo na Meta"}
                </FormHelperText>
              </FormControl>
            </Grid>
            ...
            <Grid xs={12} md={6} item>
              <FormControl className={classes.selectContainer}>
                ...
                />
                <FormHelperText>
                  {loadingMetaSdkVersion ? "Atualizando..." : "Exemplo: v25.0"}
                </FormHelperText>
              </FormControl>
            </Grid>
            ...
            <Grid xs={12} sm={6} md={4} item>
              <ToggleSetting
                label="Exigir permissão business_management"
      ...
      <div style={sectionStyle}>
        <div style={sectionHeaderStyle}>
          ...
          <span style={sectionTitleStyle}>Configurações Gerais</span>
        </div>
        <Grid spacing={2} container>
          {isSuper() ? (
            <Grid xs={12} sm={6} md={4} item>
      ...
      <div style={sectionStyle}>
        ...
        <Grid spacing={2} container>
          ...
          <Grid xs={12} sm={6} md={4} item>
            <ToggleSetting
              label="Ativar sugestões de respostas"
          ...
          <Grid xs={12} md={12} item>
            <FormControl className={classes.selectContainer}>
              ...
              <FormHelperText>
                {loadingAiApiKey
                  ? "Atualizando..."
                  : "Sua chave da OpenAI ficará salva no banco"}
              </FormHelperText>
            </FormControl>
          </Grid>
          ...
          <Grid xs={12} sm={6} md={4} item>
            <FormControl className={classes.selectContainer}>
              <TextField
                ...
                margin="dense"
                type="number"
                label="Qtd. mensagens analisadas"
                variant="outlined"
          ...
          <Grid xs={12} item>
            <FormControl className={classes.selectContainer}>
              ...
              <FormHelperText>
                Defina como a IA deve responder
              </FormHelperText>
            </FormControl>
          </Grid>
      ...
      <div style={sectionStyle}>
        <div style={sectionHeaderStyle}>
          <div style={{ width: 4, height: 20, background: "#555555", borderRadius: 2 }} />
          <span style={sectionTitleStyle}>Agendamento & Bot</span>
        </div>
        <Grid spacing={2} container>
          <Grid xs={12} sm={6} md={4} item>
            <FormControl
      ...
      <OnlyForSuperUser
        ...
        yes={() => (
          <div style={sectionStyle}>
            <div style={sectionHeaderStyle}>
              <div style={{ width: 4, height: 20, background: "#555555", borderRadius: 2 }} />
              <span style={sectionTitleStyle}>Cadastro de Empresas</span>
            </div>
            <Grid spacing={2} container>
              <Grid xs={12} sm={6} md={4} item>
                <ToggleSetting
      ...
      <div style={sectionStyle}>
        <div style={sectionHeaderStyle}>
          <div style={{ width: 4, height: 20, background: "#555555", borderRadius: 2 }} />
          <span style={sectionTitleStyle}>Notificações Push</span>
        </div>
        <Grid spacing={2} container alignItems="center">
          ...
          <Grid xs={12} sm={6} md={8} item>
            <span style={{ fontSize: 12, color: "#666" }}>
              Ative para receber notificações push neste navegador quando houver novas
              mensagens.
            </span>
          </Grid>
        </Grid>
          ...
          {isSuper() ? (
            <FormControl className={classes.selectContainer}>
              ...
              <label htmlFor="eficertificado">
                ...
                >
                  {loadingEfiCertificado ? "Enviando..." : "Enviar Certificado .P12 Efí"}
                </Button>
              </label>
          ...
          {isSuper() ? (
            <FormControl className={classes.selectContainer}>
              <TextField
                ...
                margin="dense"
                type="password"
                label="Senha do Certificado Efí"
                variant="outlined"
