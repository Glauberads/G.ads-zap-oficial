            ...
            <Table size="small">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="center" className={classes.tableHeader}>Tipo</TableCell>
                  ...
                  <TableCell align="center" className={classes.tableHeader}>Canal/Provedor</TableCell>
                ...
                <>
                  {campaigns.map((campaign) => (
                    <TableRow key={campaign.id} hover>
                      ...
                      <TableCell align="center" className={classes.tableCell}>
                        {campaign.campaignType === "email"
                          ? campaign.emailProvider || "sendgrid"
