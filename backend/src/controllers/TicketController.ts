...
import GenerateAiSuggestionService from "../services/OpenAIService/GenerateAiSuggestionService";
...
/**
 * Gera sugestão de resposta usando IA para o atendente
 */
export const aiSuggestion = async (
  ...
  const suggestion = await GenerateAiSuggestionService({
    ticketId,
    companyId,
