...
export const store = async (req: Request, res: Response): Promise<Response> => {
  ...
  try {
    ...
    const processedData = {
      ...
      confirmation: campaignType === "email" ? false : confirmation,
      scheduledAt,
      contactListId: contactListId || null,
      tagListId: tagListId === "Nenhuma" ? null : tagListId,
      whatsappId: campaignType === "email" ? null : whatsappId,
      userId: userId || null,
      ...
      emailRatePerMinute: emailRatePerMinute || 5,
