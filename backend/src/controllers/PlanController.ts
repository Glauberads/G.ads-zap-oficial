...
export const store = async (req: Request, res: Response): Promise<Response> => {
  ...
  // Regra importante: Email Marketing depende de Campanhas
  if (!newPlan.useCampaigns) {
    newPlan.useEmailMarketing = false;
  }
...
export const update = async (
  ...
  // Regra importante: Email Marketing depende de Campanhas
  if (!planData.useCampaigns) {
    planData.useEmailMarketing = false;
  }
