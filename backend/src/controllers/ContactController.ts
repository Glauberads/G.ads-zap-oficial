...
export const importXls = async (
  ...
  try {
    ...
    const contactData = {
      ...
      isGroup: false,
      email,
      whatsappUsername: normalizeWhatsappUsername(whatsappUsername),
      companyId,
      whatsappId,
...
export const store = async (req: Request, res: Response): Promise<Response> => {
  ...
  const contact = await CreateContactService({
    ...
    companyId,
    whatsappUsername: normalizeWhatsappUsername(newContact.whatsappUsername)
  });
...
export const update = async (
  ...
  if (contactData.whatsappUsername) {
    contactData.whatsappUsername = normalizeWhatsappUsername(contactData.whatsappUsername);
  }
